        ...
        <VStack mt="8" spacing="5">
          ...
          >
            ...
            <Text fontSize={"25px"} color={"primary.main1"}>
              ...
              mais rápido possivel, em breve você receberá no seu email o resumo
              do pedido e sua nota fiscal, enviaremos também um email para cada
              atulização no status de seu pedido.
            </Text>
          </Box>
        </VStack>
        <Button
